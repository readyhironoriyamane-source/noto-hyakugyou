    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <main className="container py-16 md:py-32">
        ...
        <section className="mb-32">
          ...
          {!isLoading && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-0" style={{ gridTemplateRows: `repeat(${Math.ceil(caseStudies.length / 3)}, auto 1fr auto auto)` }}>
