      ...
      <div className="container py-16 md:py-24">
        <div className="max-w-4xl mx-auto space-y-24">
          ...
          <section>
            ...
            <div className="space-y-6 text-stone-700 leading-loose">
              <p className="text-lg">
          ...
          <section className="pt-12 border-t border-stone-200">
            ...
            <div className="bg-stone-100 p-8 md:p-12">
              <div className="grid md:grid-cols-3 gap-8 text-center">
                <div>
                  <div className="text-5xl font-serif text-stone-900 mb-2">3</div>
                  <div className="text-sm text-stone-600 tracking-widest">記録済み産業</div>
                </div>
                <div>
                  <div className="text-5xl font-serif text-stone-900 mb-2">100</div>
                  <div className="text-sm text-stone-600 tracking-widest">目標産業数</div>
                </div>
                <div>
                  <div className="text-5xl font-serif text-stone-900 mb-2">97</div>
                  <div className="text-sm text-stone-600 tracking-widest">残り産業数</div>
                </div>
              </div>
          ...
          {/* CTA */}
          <section className="pt-12 border-t border-stone-200">
            <div className="bg-stone-900 text-white p-12 text-center">
