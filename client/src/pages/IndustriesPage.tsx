      ...
      <main className="pt-[60px]">
        <section className="bg-[#F9F8F4] py-20">
          <div className="max-w-[1140px] mx-auto px-6">
            ...
            {/* 事例カードグリッド */}
            {!isLoading && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-0" style={{ gridTemplateRows: `repeat(${Math.ceil(filteredItems.length / 3)}, auto 1fr 1fr auto)` }}>
