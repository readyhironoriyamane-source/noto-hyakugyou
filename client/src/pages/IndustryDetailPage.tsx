          ...
          <div className="relative ml-6 md:ml-6 mb-16">
            ...
            <div className="relative pl-8 md:pl-12 mb-16">
              ...
              {industry.decisionMatrix && (
                <div className="ml-0 md:ml-0 max-w-full md:max-w-[800px] relative z-10 bg-[#F8F9FA] border-[3px] border-[#2D7F8F] p-6 md:p-10 rounded-xl my-12">
                  <div className="mb-6">
            ...
            <div className="relative pl-8 md:pl-12 mb-16">
              ...
              {industry.barriers && industry.barriers.checklist && (
                <div className="ml-0 md:ml-0 max-w-full md:max-w-[800px] relative z-10 bg-white border border-[#E0E0E0] border-l-[8px] border-l-[#C8A882] p-6 md:p-8 rounded-lg my-12 shadow-sm">
              ...
              {(() => {
                ...
                if (howToOvercomeMatch && howToOvercomeMatch[1]) {
                  ...
                  if (items.length > 0) {
                    return (
                      <div className="ml-0 md:ml-0 max-w-full md:max-w-[800px] relative z-10 bg-[#F0F7F8] border border-[#E0E0E0] border-l-[4px] border-l-[#2D7F8F] p-6 md:p-8 rounded-lg mt-8 shadow-sm">
                        <div className="mb-5">
