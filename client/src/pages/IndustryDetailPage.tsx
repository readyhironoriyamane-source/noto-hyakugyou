...
export default function IndustryDetailPage() {
  ...
  if (industry.id === 101 || industry.id === 102 || industry.id === 104 || industry.id === 106 || industry.id === 107) {
    return (
      <div className="min-h-screen bg-[#F9F8F4] font-sans text-gray-800">
        ...
        <main className="max-w-3xl mx-auto px-4 md:px-6 py-12 md:py-20">
          ...
          <div className="mb-12 flex flex-col items-start gap-2">
            <div className="text-gray-600 text-sm flex justify-start gap-4">
                    ...
                    <div className="flex-1 bg-white p-5 md:p-6 rounded-lg border border-[#E0E0E0] shadow-sm">
                      ...
                      <ul className="space-y-2 text-sm md:text-base leading-[1.8] text-[#333]">
                        ...
                        {industry.decisionMatrix.optionA.cons && industry.decisionMatrix.optionA.cons.map((con: string, i: number) => (
                          <li key={`con-${i}`} className="flex items-start gap-2 text-[#333]">
                            <span className="text-[#333] mt-1">•</span>
                            <span>{con}</span>
                          </li>
                        ))}
